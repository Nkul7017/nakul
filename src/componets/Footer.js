...
function Footer() {
  return (
    <>
    <div className='w-screen h-[150px] text-white bg-[#1A1A1A] mt-1'>
    <div className=' w-[90vw] sm:w-[85vw] lg:w-[78vw] h-[100%] flex flex-col md:flex-row justify-center gap-5  md:items-center md:justify-between mx-auto'>
   <div>
 ...
 <a href="mailto:thakurnakul119@gmail.com" target='_blank'
          ...
          <a href="https://www.linkedin.com/in/nakulthakur17/" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 16 16"><path fill="white" d="M3.44 4.89c.8 0 1.44-.65 1.44-1.44s-.65-1.44-1.44-1.44S2 2.66 2 3.45s.65 1.44 1.44 1.44m2.81 1.09V14h2.48v-3.96c0-1.05.2-2.06 1.49-2.06s1.29 1.2 1.29 2.12V14H14V9.6c0-2.16-.46-3.82-2.98-3.82c-1.21 0-2.02.66-2.35 1.29h-.03v-1.1H6.26Zm-4.05 0h2.49V14H2.2z"/></svg></a>
